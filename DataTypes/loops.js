...
for (let i = 0; i < 5; i++)
// The Variable let i = 0 means it starting at the 0 index, 
// i < 5 means that the max value is 5 
// i++ means that its going up by one 
    console.log('Hi!');
...
for (let j = 0; j < 10; j++)
//  The variable let j = 0 means the starts at 0
// j < 10 means that the max value 10 
// j++ means that its going up by one
    console.log(j + 1); // Because of the j + 1 instead of starting at 0 it is going to start at 1    
...
//var greekGods = ['Zeus', 'Hades', 'Hermies', 'Poseidon'] - definning the array as greakGods 
//for(var k = 0; k < greekGods.length; k++) - We start with Zues and going until Poseidon and it going to go up by one 
//var currentGod = greekGods[k]; - Giving the variable currentGod as the value of Zues 
...
var name = ['Spencer', 'Mistsie', 'Ronald']
